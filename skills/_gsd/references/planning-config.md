...
node "/Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/bin/gsd-tools.cjs" commit "docs: update state" --files .planning/STATE.md

# Load config via state load (returns JSON):
INIT=$(node "/Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/bin/gsd-tools.cjs" state load)
