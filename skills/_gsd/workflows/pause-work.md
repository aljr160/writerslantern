...
```bash
timestamp=$(node "/Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/bin/gsd-tools.cjs" current-timestamp full --raw)
```
</step>

<step name="commit">
```bash
node "/Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/bin/gsd-tools.cjs" commit "wip: [phase-name] paused at task [X]/[Y]" --files .planning/phases/*/.continue-here.md
```
</step>
