...
```bash
TRANSITION=$(node "/Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/bin/gsd-tools.cjs" phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node "/Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/bin/gsd-tools.cjs" progress bar --raw)
```
...
```bash
node "/Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/bin/gsd-tools.cjs" config-set workflow._auto_chain_active false
```
