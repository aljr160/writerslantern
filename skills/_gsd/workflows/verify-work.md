...
<template>
@/Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/templates/UAT.md
</template>
...
```bash
INIT=$(node "/Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/bin/gsd-tools.cjs" init verify-work "${PHASE_ARG}")
...
Commit the UAT file:
```bash
node "/Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/bin/gsd-tools.cjs" commit "test({phase_num}): complete UAT - {passed} passed, {issues} issues" --files ".planning/phases/XX-name/{phase_num}-UAT.md"
```
...
- Follow @/Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/workflows/diagnose-issues.md
