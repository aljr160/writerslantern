...
<!-- For checkpoint task examples and patterns, see @/Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/references/checkpoints.md -->
...
See `/Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/references/tdd.md` for TDD plan structure.
...
See `/Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/templates/user-setup.md` for full schema and examples
...
See `/Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/workflows/verify-phase.md` for verification logic.
