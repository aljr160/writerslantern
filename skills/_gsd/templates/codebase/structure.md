...
- Usage: Reference from command with `@/Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/al/.openclaw/workspace-inkkeeper/skills/_gsd/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
